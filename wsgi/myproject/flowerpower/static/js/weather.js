...
Meteogram.prototype.tooltipFormatter = function (tooltip) {
    ...
    // Add wind
    ret += '<tr><td style="vertical-align: top">\u25CF Vento</td><td style="white-space:nowrap">' + this.windDirectionNames[index] +
...
Meteogram.prototype.getTitle = function () {
    //return 'Previsão de Tempo para ' + this.xml.location.name + ', ' + this.xml.location.country;
};
...
Meteogram.prototype.parseYrData = function () {
    ...
    if (!xml || !xml.forecast) {
        $('#loading').html('<i class="fa fa-frown-o"></i> Falhou a carregar dados. p.f.f. tente novamente');
        return;
    }
...
$(function () { // On DOM ready...
    ...
    //if (!location.hash) {
    if (!location) {
    var place = 'Portugal/Braga/Vila_Verde';
    ...
    var location = 'https://www.yr.no/place/' + place + '/forecast_hour_by_hour.xml';
